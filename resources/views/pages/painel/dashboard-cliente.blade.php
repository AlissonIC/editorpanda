...
<div class="row g-4 mb-4">
    <div class="col-lg-6">
        <div class="panda-card h-100">
            ...
            @endforelse
            <a href="{{ route('painel.albuns.index') }}" class="d-inline-block mt-3 small text-decoration-none">Ver todos os álbuns →</a>
        </div>
    </div>
    <div class="col-lg-6">
        <div class="panda-card h-100">
...
<div class="panda-card">
    ...
    <div class="row g-3">
        <div class="col-6 col-md-3">
            <a href="{{ route('painel.eventos.index') }}" class="d-block text-decoration-none text-dark border rounded p-3 h-100">
        ...
        <div class="col-6 col-md-3">
            <a href="{{ route('painel.albuns.index') }}" class="d-block text-decoration-none text-dark border rounded p-3 h-100">
        ...
        <div class="col-6 col-md-3">
            <a href="{{ route('painel.pedidos.index') }}" class="d-block text-decoration-none text-dark border rounded p-3 h-100">
        ...
        <div class="col-6 col-md-3">
            <a href="{{ route('painel.relatorio.index') }}" class="d-block text-decoration-none text-dark border rounded p-3 h-100">
